...
public void whenNotProperLengthTest() {
	...
	assertFalse(a.whenNotProperLength("123456789101").equals("6~12자 내로 입력해주세요."));
	assertFalse(a.whenNotProperLength("abcdefg").equals("6~12자 내로 입력해주세요."));
	assertFalse(a.whenNotProperLength("가나다라마바").equals("6~12자 내로 입력해주세요."));
	assertFalse(a.whenNotProperLength("가나다라마바사아자차카타").equals("6~12자 내로 입력해주세요."));
